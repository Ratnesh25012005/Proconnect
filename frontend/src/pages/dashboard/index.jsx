                          ...
                          <div style={{display:"flex", gap:"1.2rem", justifyContent:"space-between"}}>
                            <p style={{fontWeight:"bold"}}>{post.userId.name}</p>
                            {
                              ...
                              <div  onClick={async()=>{
                                ...
                                <svg style={{height:"1.3em",color:"red"}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="size-6">
                ...
                {postState.comments.length !== 0 &&
                  <div>
                    {postState.comments.map((comment,index)=>{
                        return (
                          <div className={styles.singleContent} key={comment._id}>
                            <div className={styles.singleContent__profileContainer} key={comment._id}>
